        ...
        <div class="top_c">
            <div class="top-menu">
                <ul class="top-menu-nav">
                    <li><a href="#">首页</a></li>
                    <li><a href="#">学生管理<i class="tip-up"></i></a>
                        <ul class="kidc">
                            <li><a target="Conframe" href="/stu?type=list">学生查询</a></li>
            ...
            <div class="top-nav">上午好，欢迎您，${username}！&nbsp;&nbsp;<a href="#">修改密码</a> | <a href="/stu?type=out">安全退出</a></div>
        </div>
        <!--头部结束-->
        <!--左边菜单开始-->
        <div class="left_c left">
            ...
            <div class="acc">
                <div>
                    <a class="one">学生管理</a>
                    <ul class="kid">
                        <li><b class="tip"></b><a target="Conframe" href="/stu?type=list">学生信息</a></li>
